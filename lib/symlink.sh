...
#
# Usage:
#   ./lib/symlink.sh             Create / update all symlinks
#   ./lib/symlink.sh --dry-run   Preview what would happen, no changes made
#   ./lib/symlink.sh --unlink    Remove managed symlinks (restore backups if any)
