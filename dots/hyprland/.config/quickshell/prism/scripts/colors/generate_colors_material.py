#!/usr/bin/env -S\_/bin/sh\_-c\_"source\_\$(eval\_echo\_\$PRISM_VIRTUAL_ENV)/bin/activate&&exec\_python\_-E\_"\$0"\_"\$@""
import argparse
import math
import json
